...
const CATEGORY_SYNONYMS: Record<string, string[]> = {
  ...
  // Produce
  onion: ["produce", "vegetables", "fresh vegetables"],
  garlic: ["produce", "vegetables", "fresh vegetables"],
  tomato: ["produce", "vegetables", "fresh vegetables"],
  potato: ["produce", "vegetables", "fresh vegetables"],
  carrot: ["produce", "vegetables", "fresh vegetables"],
  pepper: ["produce", "vegetables", "fresh vegetables"],
  lettuce: ["produce", "vegetables", "salad"],
  spinach: ["produce", "vegetables", "salad"],
  broccoli: ["produce", "vegetables", "fresh vegetables"],
  cucumber: ["produce", "vegetables", "fresh vegetables"],
  mushroom: ["produce", "vegetables", "fresh vegetables"],
  avocado: ["produce", "fruit", "fresh fruit"],
  apple: ["produce", "fruit", "fresh fruit"],
  banana: ["produce", "fruit", "fresh fruit"],
  orange: ["produce", "fruit", "fresh fruit", "citrus"],
  lemon: ["produce", "fruit", "citrus"],
  lime: ["produce", "fruit", "citrus"],
  grape: ["produce", "fruit", "fresh fruit"],
  berry: ["produce", "fruit", "berries"],
  strawberry: ["produce", "fruit", "berries"],
  blueberry: ["produce", "fruit", "berries"],
  raspberry: ["produce", "fruit", "berries"],
  mango: ["produce", "fruit", "fresh fruit"],
  pear: ["produce", "fruit", "fresh fruit"],
  peach: ["produce", "fruit", "fresh fruit"],
  melon: ["produce", "fruit", "fresh fruit"],
  watermelon: ["produce", "fruit", "fresh fruit"],
  // Eggs & Bread
  egg: ["eggs", "dairy", "breakfast"],
  eggs: ["eggs", "dairy", "breakfast"],
  milk: ["milk", "dairy"],
  bread: ["bread", "bakery"],
  butter: ["butter", "dairy"],
